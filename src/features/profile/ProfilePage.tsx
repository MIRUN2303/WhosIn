              ...
              <Card padding="md">
                ...
                <ResponsiveContainer width="100%" height={140}>
                  <BarChart data={stats.monthlyActivity} barGap={2}>
                    ...
                    <YAxis hide />
                    <Tooltip
                      contentStyle={{ background: '#1e1535', border: '1px solid rgba(255,255,255,0.1)', borderRadius: '12px' }}
                ...
                return (
                  ...
                  >
                    ...
                    <div
                      ...
                      style={{
                        color: RARITY_COLORS[badge.rarity as keyof typeof RARITY_COLORS],
                        background: `${RARITY_COLORS[badge.rarity as keyof typeof RARITY_COLORS]}20`,
                      }}
                    >
                      {badge.rarity}
                    </div>
                ...
                <Card key={s.sport} padding="md">
                  <div className="flex items-center gap-3 mb-3">
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-white/50 text-xs">{s.matches} matches · {s.wins} wins</p>
                    </div>
            ...
            >
              {[
                ...
                <div key={i} className="glass rounded-2xl p-3 flex items-center gap-3">
                  ...
                  <div className="flex-1">
                    <p className="text-white/80 text-sm font-medium">vs {match.opp}</p>
