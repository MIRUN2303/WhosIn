      ...
      <motion.div initial={{ opacity: 0, y: 24 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6, ease: [0.22, 1, 0.36, 1] as const }} className="w-full max-w-sm relative z-10">
        ...
        <form onSubmit={handleSubmit} className="space-y-3">
          ...
          <motion.button type="submit" disabled={loading}
            ...
            className="btn-lime w-full py-3 font-black text-sm disabled:opacity-50 flex items-center justify-center gap-2"
        ...
        <motion.div custom={3} variants={formItem} initial="initial" animate="animate" className="relative my-4">
        ...
        <motion.p custom={5} variants={formItem} initial="initial" animate="animate" className="text-white/30 text-xs text-center mt-4">
